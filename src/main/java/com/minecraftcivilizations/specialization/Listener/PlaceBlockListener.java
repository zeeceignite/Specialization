...
public class PlaceBlockListener implements Listener {
    ...
    public void onBlockPlace(BlockPlaceEvent event) {
        Pair<SkillType, Double> pair = SpecializationConfig.getXpGainFromPlacingConfig().get(event.getBlockPlaced().getType(), new TypeToken<Pair<SkillType, Double>>() {}.getType());
        if (pair != null) {
